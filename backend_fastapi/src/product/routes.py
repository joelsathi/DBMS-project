...
def get_product_list(response: Response, page_num: int = 1, page_size: int = 10):
    ...
    ret = getPagination("/product", total=total, serialized_rows=serialized_rows, page_num=page_num, page_size=page_size)
    return ret
...
def get_variant_list(response: Response, page_num: int = 1, page_size: int = 10):
    ...
    ret = getPagination("/variant", total=total, serialized_rows=serialized_rows, page_num=page_num, page_size=page_size)
    return ret
...
def get_subcategory_list(response: Response, page_num: int = 1, page_size: int = 10):
    ...
    ret = getPagination("/subcategory", total=total, serialized_rows=serialized_rows, page_num=page_num, page_size=page_size)
    return ret
...
def get_supercategory_list(response: Response, page_num: int = 1, page_size: int = 10):
    ...
    ret = getPagination("/supercategory", total=total, serialized_rows=serialized_rows, page_num=page_num, page_size=page_size)
    return ret
...
def get_discount_list(response: Response, page_num: int = 1, page_size: int = 10):
    ...
    ret = getPagination("/discount", total=total, serialized_rows=serialized_rows, page_num=page_num, page_size=page_size)
    return ret
...
def get_options_list(response: Response, page_num: int = 1, page_size: int = 10):
    ...
    ret = getPagination("/options", total=total, serialized_rows=serialized_rows, page_num=page_num, page_size=page_size)
    return ret
...
def get_inventory_list(response: Response, page_num: int = 1, page_size: int = 10):
    ...
    ret = getPagination("/inventory", total=total, serialized_rows=serialized_rows, page_num=page_num, page_size=page_size)
    return ret
...
def get_product_subcategory_list(response: Response, page_num: int = 1, page_size: int = 10):
    ...
    ret = getPagination("/product_subcategory", total=total, serialized_rows=serialized_rows, page_num=page_num, page_size=page_size)
    return ret
...
def get_product_variant_options_list(response: Response, page_num: int = 1, page_size: int = 10):
    ...
    ret = getPagination("/product_variant_options", total=total, serialized_rows=serialized_rows, page_num=page_num, page_size=page_size)
    return ret
